package com.sgffsg.plusminusview.view;
...
import com.sgffsg.plusminusview.utils.DisplayUtils;
...
public class PlusMinusView extends View{
    ...
    private void initView() {
        width= DisplayUtils.dpToPx(getContext(),124);
        height=DisplayUtils.dpToPx(getContext(),42);
        edge=DisplayUtils.dpToPx(getContext(),1);
        minusViewWidth=DisplayUtils.dpToPx(getContext(),20);
        minusViewPaintSize=DisplayUtils.dpToPx(getContext(),3);
        roundRadius=DisplayUtils.dpToPx(getContext(),2);
